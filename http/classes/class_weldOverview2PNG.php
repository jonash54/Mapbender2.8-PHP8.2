<?php
# $Id: class_weldOverview2PNG.php 9936 2018-08-09 12:30:02Z armin11 $
...
class weldOverview2PNG{
	...
	function __construct($url_overview,$url_extent,$filename){
        ...
        */
        function weldOverview2PNG($url_overview,$url_extent,$filename){
                self::__construct($url_overview,$url_extent,$filename);
	}
