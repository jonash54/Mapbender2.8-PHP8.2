<?php
# $Id: mod_setBBOX1.php 7734 2011-04-04 10:10:28Z verenadiewald $
...
eventAfterLoadWMS.register(function () {
	...
	var transformationEpsg = "<?php echo Mapbender::session()->get("mb_myBBOXEpsg_transform")?>";
	var performTransformation = 
		(transformationEpsg != "") ? true : false;
